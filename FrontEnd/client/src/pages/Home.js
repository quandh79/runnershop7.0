                ...
                <Row>
                    <Col lg={{span: 9}}>
                        <div style={intro}>
                            ...
                            <p><EnvironmentOutlined /> Số 8, Tôn Thất Thuyết, Mỹ Đình, Từ Liêm, Hà Nội</p>
                            <p><WhatsAppOutlined /> +(84) 35 442 9977</p>
                            <p><MailOutlined /> runnershop@gmail.com</p>
                        </div>
                    </Col>
                    <Col lg={{span: 7}}>
                        <div style={intro}>
                            <h5 style={{color: '#fa8c16'}}>FAN PAGE</h5>
                            <FacebookProvider appId="quan2201">
                                <Page href="https://www.facebook.com/quan2201/"/>
                            </FacebookProvider>
