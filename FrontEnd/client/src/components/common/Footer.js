        ...
        <footer style={{width: '100%',  background: '#ffffff'}}>
            <div style={{width: '75%', margin: '0 auto'}}>
                <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
                    <Col span={6}>
                        <article className="article-footer">
                            ...
                            <h6>Chăm sóc khách hàng: +8435 442 9977</h6>
                            <h6>Email: runnershop@gmail.com</h6>
                        </article>
                    </Col>
                    <Col span={6}>
                        <article className="article-footer">
                            <h4>VỀ Runner SHOP</h4>
                            <h6>Runner Shop chuyên buôn bán và cung cấp quần áo, giày dép, các phục kiện thời trang cao cấp</h6>
                        </article>
                    </Col>
                    <Col span={6}>
                        <article className="article-footer">
                ...
                <div style={{textAlign: 'center'}}>
                    <br></br>
                    <h4>Copyright 2023 All rights reserved | made by Runner Shop</h4>
                    <br></br>
                </div>
            </div>
        </footer>
