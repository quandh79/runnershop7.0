...
export default class OrderTransport extends Component {
    ...
    callApi = async() => {
        ...
        let order = await axiosInstance(`ManageOrder/GetAllOrderTransport`, 'GET')
        .then(res => res.data);
    ...
    render() {
        //
        const {OrderTransport, isLoading, visible, visibleCancel, orderDetailList, customerItem, 
            ...
            <Header></Header>   
                <div className="main_container">
                    ...
                    <div className="content">
                        ...
                        <BreadScrumb title="Đơn hàng vận chuyển"></BreadScrumb>
                        <br/>
                        ...
                        <Row>
                            <Col span={24}>
                            <Table style={{ margin: '10px' }} columns={columns} dataSource={OrderTransport}
                            scroll={true}
