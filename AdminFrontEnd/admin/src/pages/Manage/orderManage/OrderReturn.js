...
export default class OrderReturn extends Component {
    ...
    callApi = async() => {
        ...
        let order = await axiosInstance(`ManageOrder/GetAllOrderRefund`, 'GET')
        .then(res => res.data);
    ...
    render() {
        //
        const {orderReturn, isLoading, visible, visibleCancel, orderDetailList, customerItem, 
            ...
            <Header></Header>   
                <div className="main_container">
                    ...
                    <div className="content">
                        ...
                        <Row>
                            <Col span={24}>
                            <Table style={{ margin: '10px' }} columns={columns} dataSource={orderReturn}
                            scroll={true}
